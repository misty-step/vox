...
- Includes plain-language generation p95 trend analysis (faster/slower vs previous, mean, best, worst) over prior persisted runs for the same PR when available.
