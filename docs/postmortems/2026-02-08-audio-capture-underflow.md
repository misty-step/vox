...
4. **Contract tests added**:
   ...
   - pipeline header-only capture guard (`DictationPipelineTests`)
5. **Process hardening**:
...
3. **Done** — Pipeline fast-fail on header-only CAF before STT.
4. **Done** — Documentation and PR/test guardrails updated.
