...
- [ ] If audio capture/conversion changed, `AudioRecorderBackendSelectionTests`, `AudioRecorderConversionTests`, and header-only CAF fast-fail coverage in `DictationPipelineTests` were updated/validated
