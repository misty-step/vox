...
public enum DiagnosticsEventNames {
    public static let pipelineTiming = "pipeline_timing"
    public static let shareTrigger = "share_triggered"
    public static let rewriteOpenRouterAttempt = "rewrite_openrouter_attempt"
    public static let rewriteModelUsed = "rewrite_model_used"
    public static let rewriteStageOutcome = "rewrite_stage_outcome"
}
