...
public enum DiagnosticsValue: Codable, Sendable, Equatable {
    case string(String)
    case int(Int)
    case double(Double)
    case bool(Bool)
...
public struct DiagnosticsEvent: Codable, Sendable, Equatable {
    ...
    public init(timestamp: String, name: String, sessionID: String?, fields: [String: DiagnosticsValue]) {
...
public struct DiagnosticsContext: Codable, Sendable, Equatable {
    public struct KeysPresent: Codable, Sendable, Equatable {
    ...
    public let processingLevel: String
    public let selectedInputDeviceConfigured: Bool

    public let sttRouting: String
    public let streamingAllowed: Bool
    public let audioBackend: String
    public let maxConcurrentSTT: Int

    public let keysPresent: KeysPresent

    public init(
        exportedAt: String, appVersion: String, appBuild: String,
        osVersion: String, processingLevel: String, selectedInputDeviceConfigured: Bool,
        sttRouting: String, streamingAllowed: Bool, audioBackend: String,
        maxConcurrentSTT: Int, keysPresent: KeysPresent
    ) {
        ...
        self.selectedInputDeviceConfigured = selectedInputDeviceConfigured
        self.sttRouting = sttRouting
        self.streamingAllowed = streamingAllowed
        self.audioBackend = audioBackend
        self.maxConcurrentSTT = maxConcurrentSTT
...
public actor DiagnosticsStore {
    ...
    public func record(name: String, sessionID: String? = nil, fields: [String: DiagnosticsValue] = [:]) {
    ...
    public func exportZip(to destinationURL: URL, context: DiagnosticsContext) async throws {
...
public extension DiagnosticsStore {
...
private extension AudioConversionError {
    ...
    var diagnosticsPayload: [String: DiagnosticsValue] {
        ...
        case .launchFailed(let underlying):
            return [
                "conversion_tool": .string("afconvert"),
