...
public final class VoxSession: ObservableObject {
    ...
    private func makePipeline(dictationID: String) -> DictationProcessing {
        ...
        return DictationPipeline(
            ...
            isOpusConversionEnabled: { await AudioConverter.isOpusConversionAvailable() },
            convertCAFToOpus: { try await AudioConverter.convertCAFToOpus(from: $0) },
            opusUnavailableReason: { await AudioConverter.opusConversionAvailability().unavailableReason },
